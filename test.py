...
def test_read_doc():
    assert len(get_data(r"/Users/akulsingh/Desktop/Internship/examples/sample.docx")) > 0
    assert type(get_data(r"/Users/akulsingh/Desktop/Internship/examples/sample.docx")) == str
def test_read_pdf():
